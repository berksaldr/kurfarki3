CLASS lhc_ZFI003_DD_Behaviour DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    ...
    METHODS get_instance_authorizations FOR INSTANCE AUTHORIZATION
      IMPORTING keys REQUEST requested_authorizations FOR ZFI003_DD_Behaviour RESULT result.

    METHODS read FOR READ
      IMPORTING keys FOR READ ZFI003_DD_Behaviour RESULT result.

    METHODS lock FOR LOCK
      IMPORTING keys FOR LOCK ZFI003_DD_Behaviour.

    METHODS kur_farki FOR MODIFY
      IMPORTING keys FOR ACTION ZFI003_DD_Behaviour~kur_farki.
...
*      ELSE.
      CLEAR zfi003_cl_dd_behaviour=>gt_table.
      zfi003_cl_dd_behaviour=>gt_table = lt_je_deep.
*      ENDIF.
    ENDIF.
...
CLASS lsc_ZFI003_DD_BEHAVIOUR IMPLEMENTATION.
  ...
  METHOD finalize.
    CLEAR zfi003_cl_dd_behaviour=>gv_pid.

    IF zfi003_cl_dd_behaviour=>gt_table IS NOT INITIAL.
      MODIFY ENTITIES OF i_journalentrytp
      ENTITY journalentry
      EXECUTE post FROM zfi003_cl_dd_behaviour=>gt_table
      ...
      ELSE.
        ...
        zfi003_cl_dd_behaviour=>gv_pid = ls_map-%pid.
  ...
  METHOD save.
    ...
    IF zfi003_cl_dd_behaviour=>gv_pid IS NOT INITIAL.
      CONVERT KEY OF i_journalentrytp FROM zfi003_cl_dd_behaviour=>gv_pid TO DATA(ls_convert).
